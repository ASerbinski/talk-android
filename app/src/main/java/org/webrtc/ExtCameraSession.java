...
class ExtCameraSession implements CameraSession {
    ...
    private class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onDisconnected(CameraDevice camera) {
            ...
            if (startFailure) {
                ...
                events.onCameraDisconnected(ExtCameraSession.this);
            }
        }
        @Override
        ...
        public void onClosed(CameraDevice camera) {
            ...
            events.onCameraClosed(ExtCameraSession.this);
        }
    }
    private class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public void onConfigured(CameraCaptureSession session) {
            ...
            surfaceTextureHelper.startListening((VideoFrame frame) -> {
                ...
                events.onFrameCaptured(ExtCameraSession.this, modifiedFrame);
                modifiedFrame.release();
            });
            Logging.d(TAG, "Camera device successfully started.");
            callback.onDone(ExtCameraSession.this);
        }
            ...
            if (availableVideoStabilization != null) {
                for (int mode : availableVideoStabilization) {
                    if (mode == CaptureRequest.CONTROL_VIDEO_STABILIZATION_MODE_ON) {
                        captureRequestBuilder.set(CaptureRequest.CONTROL_VIDEO_STABILIZATION_MODE,
                                                  CaptureRequest.CONTROL_VIDEO_STABILIZATION_MODE_OFF); //TODO This
                        // is changed
    ...
    public static void create(CreateSessionCallback callback, Events events,
                              ...
                              int framerate) {
        new ExtCameraSession(callback, events, applicationContext, cameraManager, surfaceTextureHelper,
                           cameraId, width, height, framerate);
    }
    private ExtCameraSession(CreateSessionCallback callback, Events events, Context applicationContext,
